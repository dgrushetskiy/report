...
/**
 * Класс, аналогичный классу {@link PrimaryRights} за тем исключением,
 * что поля из себя представляют JavaFX Property. Это может пригодиться.
 *
 * JPA с ним работает аналогично классу {@link PrimaryRights}.
 */
public class PrimaryRightsWitchProperties {
    ...
    public PrimaryRightsWitchProperties() {
    }

    public PrimaryRightsWitchProperties(LongProperty id, LongProperty unom, StringProperty kadNom, StringProperty kadNomPrava, StringProperty explikazia, ObjectProperty<BigDecimal> sqrOForm, StringProperty vidPrava, StringProperty nameSubject) {
        this.id = id;
        this.unom = unom;
        this.kadNom = kadNom;
